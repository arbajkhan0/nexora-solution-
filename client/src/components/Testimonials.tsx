  ...
  const testimonials = [
    {
      ...
      content: 'StarAI transformed our business operations. Their AI automation solutions reduced our manual work by 80% and saved us $500K annually.',
      rating: 5,
    ...
    },
    {
      ...
      content: 'The team at StarAI built our entire SaaS platform from scratch. Their expertise in scalable architecture is unmatched.',
      rating: 5,
    ...
    },
    {
      name: 'David Park',
      role: 'CTO, FinanceHub',
      content: 'Working with StarAI was seamless. They delivered our project on time, under budget, and exceeded expectations.',
      rating: 5,
    ...
    },
    {
      ...
      content: 'From concept to launch, StarAI guided us through every step. They\'re not just developers, they\'re strategic partners.',
      rating: 5,
