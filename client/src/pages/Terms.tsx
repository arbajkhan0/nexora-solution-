            ...
            >
              <div>
                ...
                <p className="text-foreground/80 leading-relaxed">
                  By accessing and using NEXORA's website and services, you agree to be bound by these Terms of Service. If you do not agree to abide by the above, please do not use this service.
                </p>
              </div>
              ...
              <div>
                ...
                <p className="text-foreground/80 leading-relaxed">
                  In no event shall NEXORA or its suppliers be liable for any damages (including, without limitation, damages for loss of data or profit, or due to business interruption) arising out of the use or inability to use the materials on NEXORA's website.
                </p>
              </div>
              ...
              <div>
                ...
                <p className="text-foreground/80 leading-relaxed">
                  The materials appearing on NEXORA's website could include technical, typographical, or photographic errors. NEXORA does not warrant that any of the materials on its website are accurate, complete, or current. NEXORA may make changes to the materials contained on its website at any time without notice.
                </p>
              </div>
              ...
              <div>
                ...
                <p className="text-foreground/80 leading-relaxed">
                  NEXORA has not reviewed all of the sites linked to its website and is not responsible for the contents of any such linked site. The inclusion of any link does not imply endorsement by NEXORA of the site. Use of any such linked website is at the user's own risk.
                </p>
              </div>
